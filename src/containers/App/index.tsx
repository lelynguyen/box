...
function App() {
  useEffect(() => {
    ...
    // Thêm event listener chỉ chạy một lần (once: true)
    document.addEventListener('click', handleClick, { once: true });

    return () => {
      // Cleanup: remove event listener (phòng trường hợp code chạy lại)
      ...
      <div className="container">
        ...
        >
          ...
          <defs>
            ...
            <path
              id="star"
              d="M4.55 0l1.4 2.85 3.15.45-2.28 2.22.54 3.13-2.81-1.48-2.81 1.48.53-3.13L0 3.3l3.14-.45z"
            />
            <path
              id="cross"
              d="M4 3.5L2.5 2 4 .5 3.5 0 2 1.5.5 0 0 .5 1.5 2 0 3.5l.5.5L2 2.5 3.5 4z"
            />
            <path
              id="heart"
              d="M2.9 0c-.37 0-.7.18-.9.47C1.8.18 1.47 0 1.1 0 .49 0 0 .49 0 1.1 0 2.6 1.56 4 2 4s2-1.4 2-2.9C4 .49 3.51 0 2.9 0z"
            />
            <path
              id="flake1"
          ...
          <g mask="url(#strokeMask3)" stroke="#F3F1E2">
            <path
              ...
              strokeWidth="32"
              strokeMiterlimit="10"
              d="M467.82 270.07c93.65-33.69 90.62-162.02 89.85-169.4-.22-2.15-.86-8.25-4.67-10 0 0-3.04-1.4-8 1.33-9.43 5.19-9.23 122.41-7.33 222"
            />
          </g>
          ...
          <g id="merryGroup" fill="#F3F1E2">
            <text x="70" y="400" className="name">
              Embes 😽 của LyNguyn!
            </text>
          </g>
        ...
        <p className="message">
          ...
          <span>
            {" "}
            I love you so much, my dear! I hope you will be happy with
          </span>
          <span> saepe eveniet!</span>
        </p>
      </div>
    </div>
  );
